...
# print(dic['hobby'])
# print(dic.get('hobby')) # get 메소드는 예외를 발생시키지 않음.
...
#     x = name.index(z)
#     print('{} Found it! {} in name'.format(z, x + 1))
# except Exception: # Exception 생략 가능, 모든 에러를 다 잡지만, 무슨 에러가 발생했는지 알기 힘들다.
#     print('Not found it! - Occured ValueError!')
# else:
#     print('Ok! else.')
# print()
...
#     x = name.index(z)
#     print('{} Found it! {} in name'.format(z, x + 1))
# except Exception as e: #alias로 예외 출력 가능
#     print(e)
#     print('Not found it! - Occured ValueError!')
# else:
#     print('Ok! else.')
